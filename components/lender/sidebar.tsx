...
import { LayoutGrid, Wallet, CreditCard, Settings } from "lucide-react"

const nav = [
  { href: "/lender", label: "Marketplace", Icon: LayoutGrid },
  { href: "/lender?tab=portfolio", label: "My Portfolio", Icon: Wallet },
  { href: "/lender?tab=payments", label: "Payments", Icon: CreditCard },
  { href: "/lender?tab=settings", label: "Settings", Icon: Settings },
]

export function LenderSidebar({ active = "Marketplace" }: { active?: string }) {
  return (
